...
<%@taglib prefix="qixin" uri="/WEB-INF/taglib/qixin-functions.tld" %>
...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/style/plugins/ztree/zTreeStyle/zTreeStyle.css">
    <style>
...
<form:form method="post" commandName="role">
    ...
    <div class="form-group">
        ...
        <input type="text" id="resourceName" name="resourceName" value="${qixin:resourceNames(role.resourceIds)}" readonly>
...
<script src="${pageContext.request.contextPath}/script/plugins/ztree/jquery.ztree.all-3.5.min.js"></script>
<script>
    $(function () {
        var setting = {
            check: {
        ...
        var zNodes =[
            ...
            { id:${r.id}, pId:${r.parentId}, name:"${r.name}", checked:${qixin:in(role.resourceIds, r.id)}},
            </c:if>
            </c:forEach>
        ];
