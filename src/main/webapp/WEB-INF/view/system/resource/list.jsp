...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/style/plugins/treetable/jquery.treetable.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/style/plugins/treetable/jquery.treetable.theme.default.css">
    <style>
        #table th, #table td {
            font-size: 14px;
            padding : 8px;
...
<script src="${pageContext.request.contextPath}/script/plugins/treetable/jquery.treetable.js"></script>
<script>
    $(function() {
